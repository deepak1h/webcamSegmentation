...
def prep_display(dets_out, img, h, w, undo_transform=True, class_color=False, mask_alpha=0.45, fps_str=''):
    ...
    """
    print("data",dets_out,"img",img)
    print(h,w, undo_transform, class_color,mask_alpha,fps_str)
    if undo_transform:
    ...
    with timer.env('Postprocess'):
        ...
        print("lol")
        print(args.display_lincomb,args.crop,args.score_threshold)
    ...
    print("lol: :::djbhjdbdhjbdhbdh: : ::  :",color_cache[None])

    for i in color_cache[None]:
        print(i)
...
def evaluate(net:Yolact, dataset, train_mode=False):
    ...
    print(args.mask_proto_debug)

    print("args.fast_nms",args.fast_nms,"args.cross_class_nms",args.cross_class_nms)
